        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                name: "Marina Silva",
                role: language === 'es' ? "Propietaria - Salon Marina Beleza" : "Proprietaria - Salao Marina Beleza",
                quote: language === 'es' ? "Atendo transformo completamente mi salon. Aumente mis agendamientos en 40% y puedo controlar todo desde un solo lugar. Lo recomiendo mucho!" : "O Atendo transformou completamente meu salao. Aumentei meus agendamentos em 40% e consigo controlar tudo de um unico lugar. Recomendo demais!",
                avatar: "👩‍💼",
                rating: 5
              },
              {
                name: "Carlos Mendes",
                role: language === 'es' ? "Gerente - Clinica Estetica Premium" : "Gerente - Clinica Estetica Premium",
                quote: language === 'es' ? "Antes pasaba horas con hojas de calculo. Ahora el sistema hace todo automaticamente. Mi facturacion crecio 35% en 3 meses." : "Antes gastava horas com planilhas. Agora o sistema faz tudo automaticamente. Meu faturamento cresceu 35% em 3 meses.",
                avatar: "👨‍💼",
                rating: 5
              },
              {
                name: "Juliana Costa",
                role: language === 'es' ? "Propietaria - Studio de Pilates" : "Proprietaria - Studio de Pilates",
                quote: language === 'es' ? "La integracion con WhatsApp es increible! Mis clientes reciben confirmaciones automaticas y nunca mas faltan a las citas." : "A integracao com WhatsApp e incrivel! Meus clientes recebem confirmacoes automaticas e nunca mais faltam reunioes.",
                avatar: "👩‍🏫",
                rating: 5
              },
              {
                name: "Roberto Alves",
                role: language === 'es' ? "Dueno - Academia Forca Total" : "Dono - Academia Forca Total",
                quote: language === 'es' ? "El ROI fue inmediato. Consegui aumentar mi ticket promedio con la precificacion inteligente. La mejor inversion que hice." : "O ROI foi imediato. Consegui aumentar meu ticket medio com a precificacao inteligente. Melhor investimento que fiz.",
                avatar: "👨‍🏫",
                rating: 5
              },
              {
                name: "Beatriz Santos",
                role: language === 'es' ? "Propietaria - Centro de Estetica" : "Proprietaria - Centro de Estetica",
                quote: language === 'es' ? "Finalmente puedo ver claramente que servicios son mas rentables. Los reportes me ayudan a tomar mejores decisiones cada dia." : "Finalmente consigo ver claramente quais servicos sao mais rentaveis. Os relatorios me ajudam a tomar melhores decisoes todos os dias.",
                avatar: "👩‍💼",
                rating: 5
              },
              {
                name: "Felipe Oliveira",
                role: language === 'es' ? "Gerente - Barberia Premium" : "Gerente - Barbearia Premium",
                quote: language === 'es' ? "Mis barberos pueden ver sus metas y comisiones en tiempo real. La motivacion del equipo aumento mucho desde que implementamos Atendo." : "Meus barbeiros conseguem ver suas metas e comissoes em tempo real. A motivacao do time aumentou muito desde que implementamos o Atendo.",
                avatar: "👨‍💼",
                rating: 5
              }
            ].map((testimonial, index) => (
              <div key={index} className="bg-white border border-border rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow animate-slide-in-up">
